...
public class VFX_Wood_ThorncrownRotate : MonoBehaviour {
    ...
    void Start()
    {
        Yrot = /*Thorncrown*/gameObject.transform.localEulerAngles.y;
        Debug.Log(Yrot);
    }
	...
	{	
		...
		/*Thorncrown*/gameObject.transform.localEulerAngles = new Vector3 (rot1,Yrot,tilt1);	// replace the Y coordinates by rot
	}
