...
public class StringsErule
{
    ...
    public static readonly string dot = "{0} subit des dégats <b>{1}</b> pendant <b>{2}</b> tours.";
    public static readonly string hot = "{0} se soigne pendant <b>{1}</b> tours.";
    public static readonly string rangeBonus = "{0} gagne <b>{1}</b> de <b>Portée</b> pendant <b>{2}</b> tours.";
    public static readonly string rangeMalus = "{0} perd <b>{1}</b> de <b>Portée</b> pendant <b>{2}</b> tours.";
    public static readonly string protectionBonus = "{0} reçoit un bonus de {1}% de protection {2}.";
    public static readonly string protectionMalus = "{0} reçoit un malus de {1}% de protection {2}.";
