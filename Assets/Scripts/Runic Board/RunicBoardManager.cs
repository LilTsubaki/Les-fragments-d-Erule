...
public class RunicBoardManager{
    ...
    private void Init()
    {
        JSONObject js = JSONObject.GetJsonObjectFromFile("JsonFiles/Spells/compatibilityMalus");
        ...
        js = JSONObject.GetJsonObjectFromFile("JsonFiles/Spells/compatibility");
        array = js.list[0];
        ...
        js = JSONObject.GetJsonObjectFromFile("JsonFiles/Spells/runeNumberInfluence");
        array = js.list[0];
