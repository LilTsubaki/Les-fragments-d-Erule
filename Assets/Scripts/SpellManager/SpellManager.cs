...
public class SpellManager
{
   ...
   // private Dictionary<int, EffectOnTime> _onTimeEffects;
    ...
    {
        JSONObject js = JSONObject.GetJsonObjectFromFile(Application.dataPath + "/Resources/JsonFiles/Spells/range.json");
    ...
    {
        JSONObject js = JSONObject.GetJsonObjectFromFile(Application.dataPath + "/Resources/JsonFiles/Spells/area.json");
        JSONObject array = js.list[0];
    ...
    {
        JSONObject js = JSONObject.GetJsonObjectFromFile(Application.dataPath + "/Resources/JsonFiles/Spells/spell.json");
        JSONObject array = js.list[0];
    ...
    {
        JSONObject js = JSONObject.GetJsonObjectFromFile(Application.dataPath + "/Resources/JsonFiles/Spells/directEffect.json");
        JSONObject array = js.list[0];
    ...
    {
        JSONObject js = JSONObject.GetJsonObjectFromFile(Application.dataPath + "/Resources/JsonFiles/Spells/onTimeEffect.json");
        JSONObject array = js.list[0];
    ...
    {
        JSONObject js = JSONObject.GetJsonObjectFromFile(Application.dataPath + "/Resources/JsonFiles/Spells/failDamage.json");
        JSONObject array = js.list[0];
