...
public class Range
{
    ...
    public bool EnemyTargetable
    {
        get
        {
            return _enemyTargetable;
        }

        set
        {
            _enemyTargetable = value;
        }
    }
    ...
    public Range(JSONObject js)
    {
        ...
        if(js.GetField("enemyTargetable") != null)
        {
            EnemyTargetable = js.GetField("enemyTargetable").b;
        }
        else
        {
